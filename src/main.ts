...
import * as popularEffects from './app/shared/components/popularTags/store/effects'
...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    provideEffects(authEffects,feedEffects,popularEffects,addToFavoritesEffects),
